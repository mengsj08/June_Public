---
name: feature-definition-research
description: 以功能定义为主线开展竞品研究，将用户任务、竞品功能程度、前代变化、实现假说及价值与创新判断串联，用关键证据缺口驱动定向调研。适用于拆解 AI 或其他产品的新功能、核查升级与首创卖点、为产品功能定义提供依据；单纯资料检索或产品目录整理不必启用完整流程。
---
