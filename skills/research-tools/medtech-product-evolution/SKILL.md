---
name: medtech-product-evolution
description: 当用户要求梳理医疗器械及配套医疗 AI 软件的产品家族、历代型号、技术与功能演进或产业化节点时使用。建立有来源的产品关系图、发布事件表与能力变化矩阵，区分地区、监管许可、供货与后继关系；覆盖内镜、呼吸机、睡眠与可穿戴设备等。单一产品当前参数查询不需要完整流程。
---
