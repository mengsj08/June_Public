...
| 方法 | 回答的问题 | 入口 |
| --- | --- | --- |
| 以功能定义为主线的竞品研究 | 功能为谁解决什么、做到什么程度、可能怎样实现、是否有价值 | [使用说明](feature-definition-research/README.md) |
| 产品与功能族谱调研 | 产品之间是什么关系、何时发布、功能如何演进 | [使用说明](product-feature-genealogy/README.md) |

两者都可独立使用，也可先研究族谱、再拆重点功能。它们不依赖专用看板、私有导入服务或另一套 Skill。当前公开的是方法、模板和虚构校准案例，不包含真实品牌研究整包；长期维护不等于充分验证，许可分别见包内说明。
